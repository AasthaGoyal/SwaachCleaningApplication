						...
						<div class="contact-form">
								...
								<div class="row clearfix">
									<div class="form-group col-lg-12 col-md-12 col-sm-12">
										<label>Name</label>
										<asp:TextBox runat="server" type="text"  Id="txtName" placeholder="Enter Your Name" required="txtname"/>
									</div>
									
									<div class="form-group col-md-6 col-sm-6">
										<label>Email</label>
										<asp:TextBox runat="server" type="email"   id="txtEmail" placeholder="Email Address" required="txtemail"/>
									</div>
									
									<div class="form-group col-md-6 col-sm-6">
										<label>Phone</label>
										<asp:TextBox runat="server" type="text"   id="txtPhoneNo" placeholder="Phone" required="txtphone"/>
									</div>
									...
									<div class="form-group col-md-12 col-sm-12">
										<asp:Button runat="server"   id="btnSubmit"  class="theme-btn message-btn" Text="Send Message" OnClick="btnSubmit_Click1" CommandName="btnSubmit_Click1" OnClientClick="btnSubmit_Click1" OnCommand="btnSubmit_Click1"></asp:Button>
